...
public class UserUpdate extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtMail, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String a = txtAddress.getText().trim();

        int statu = db.customerUpdate(cid,n, m, t, a);
        if (statu > 0) {
            JOptionPane.showMessageDialog(rootPane, "Customer update Succes!");
            Dashboard dh = new Dashboard(); // DASHBOARD' ACILSIN diye türettim.
            dh.setVisible(true);
            dispose(); // sonra kendi ekranını kapatacak kendisinin!
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        // DIREKT CARPIDAN KAPATILIRSA BAGLANTI ACILSIN
        Dashboard dh = new Dashboard(); // DASHBOARD' ACILSIN diye türettim.
        dh.setVisible(true);
        dispose(); // sonra kendi ekranını kapatacak kendisinin!
